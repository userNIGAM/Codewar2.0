...
//   const firstInputRef = useRef(null);      // renamed for clarity (point 6)
//   const modalRef = useRef(null);           // for backdrop click detection
...
//   // Auto-focus first input on step 1 (point 6)
//   useEffect(() => {
//     if (isOpen && regStep === 1 && firstInputRef.current) {
//       firstInputRef.current.focus();
//     }
//   }, [isOpen, regStep]);

//   // Compilation progress effect – with cleanup (point 8)
//   useEffect(() => {
//     if (regStep === 3) {
...
//   // Close on backdrop click (point 2 & 9)
...
//   // Lock body scroll (point 7) – already present, kept as is
//   useEffect(() => {
//     if (!isOpen) return;
...
//     <AnimatePresence>
//       {isOpen && (
//         // Outer container – fixes mobile scroll bounce (point 7)
//         <div className="fixed inset-0 z-50 overflow-y-auto overscroll-contain">
//           {/* Backdrop – absolute, with click handler */}
//           <motion.div
//             initial={{ opacity: 0 }}
//             animate={{ opacity: 1 }}
//             exit={{ opacity: 0 }}
...
//           {/* Content wrapper – ensures centering & scroll (point 9) */}
...
//               transition={{ duration: 0.25 }} // ✅ fast, flicker‑free (point 10)
...
//               onClick={(e) => e.stopPropagation()} // prevents bubbling to backdrop
//             >
...
//                     </span>
//                     <input
//                       ref={firstInputRef} // ✅ autofocus (point 6)
//                       type="text"
//                       maxLength={18}
